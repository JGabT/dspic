...
{           
	...
	DAC3CONL = 0x8010; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP3C; DACOEN disabled; 
	...
	DAC3DATH = 4000;//4095;//4095;//0x83E;//0xD16; //DACDATH 3350; 
