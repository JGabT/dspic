...
{           
	...
	DAC2CONL = 0x8018; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP2D; DACOEN disabled; 
	...
	DAC2DATH = 4000;//4095;//0xBFF; //DACDATH 3071; 
